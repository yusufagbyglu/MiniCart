...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $shopManagerPerms = $this->getPermissionIds($allPermissions, [
            ...
            'products.view', 'products.view-all', 'products.create', 'products.update', 
            'products.delete', 'products.manage-stock', 'products.manage-images', 
            'products.set-featured', 'products.restore',
            'taxes.view', 'taxes.create', 'taxes.update',
            'orders.view-all', 'orders.update', 'orders.change-status', 'orders.cancel',
            'payments.view', 'payments.process',
            'shipping.view', 'shipping.update', 'shipping.manage-tracking',
            'coupons.view', 'coupons.create', 'coupons.update', 'coupons.delete',
            'reviews.view', 'reviews.approve', 'reviews.delete-all',
            'stock-history.view', 'stock-history.create',
            'reports.sales', 'reports.products', 'reports.customers', 'reports.export',
            'cart.view-all',
        ]);
        ...
        $supportPerms = $this->getPermissionIds($allPermissions, [
            'users.view',
            'categories.view',
            'products.view', 'products.view-all',
            'orders.view-all', 'orders.update', 'orders.change-status', 'orders.cancel',
            'payments.view',
            'shipping.view', 'shipping.update', 'shipping.manage-tracking',
            'reviews.view', 'reviews.approve', 'reviews.delete-all',
            'addresses.view-all',
            'notifications.send', 'notifications.view-all',
            'audit-logs.view',
        ]);
        ...
        $customerPerms = $this->getPermissionIds($allPermissions, [
            ...
            'cart.manage-own',
            'reviews.create', 'reviews.update-own', 'reviews.delete-own',
            'wishlist.manage-own',
