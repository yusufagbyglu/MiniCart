...
class UserPermissionPolicy
{
    ...
    {
        return $user->hasPermissionTo('restore_users'); // Assuming you have this permission
    }
    ...
    {
        return $user->hasPermissionTo('force_delete_users'); // Assuming you have this permission
    }
}
