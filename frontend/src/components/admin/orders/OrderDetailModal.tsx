            ...
            <div className="space-y-6">
                ...
                <div className="bg-gray-50 dark:bg-gray-800/50 rounded-lg p-4">
                    ...
                    <select
                        ...
                        className="w-full max-w-xs rounded-lg border border-gray-300 bg-white px-4 py-2 text-sm focus:border-brand-300 focus:outline-none focus:ring-3 focus:ring-brand-500/10 dark:border-gray-600 dark:bg-gray-900 dark:text-white"
                    >
                    ...
                    <div className="space-y-2 text-sm">
                        <div className="flex justify-between">
                            ...
                            <span className="text-gray-800 dark:text-white">
                                ${(order.total_amount - order.tax_amount + order.discount_amount).toFixed(2)}
                            </span>
                        </div>
                        {order.tax_amount > 0 && (
                            <div className="flex justify-between">
                        ...
                        <div className="flex justify-between font-semibold text-lg pt-2 border-t border-gray-200 dark:border-gray-700">
                            ...
                            <span className="text-gray-800 dark:text-white">${order.total_amount}</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex justify-end pt-4 border-t border-gray-200 dark:border-gray-700">
                    <button
                        onClick={onClose}
                        className="px-6 py-2 rounded-lg bg-gray-200 text-gray-700 hover:bg-gray-300 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                    >
                        Close
                    </button>
                </div>
